...
/**
 * Verifica las credenciales de acceso al sistema. Delega la búsqueda del
 * usuario en AccesoDatosUsuario y valida la contraseña contra el hash
 * almacenado.
 *
 * @class InicioSesion
 */
class InicioSesion {
    ...
    /**
     * Autentica a un usuario a partir de su cédula y contraseña. Se retorna
     * NULL tanto si el usuario no existe como si la contraseña es incorrecta,
     ...
     * @return Usuario|null El objeto Usuario si las credenciales son válidas,
